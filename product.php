...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
		...
		if (!empty($id)) {
		?>
			<a class="navbar-brand" style="color:black; text-decoration:none;"><i class="far fa-user"><?php if (isset($id)) {
																											echo $vr['pld_name'];
																										} ?></i></a>
		<?php
		}
			...
			<div class="tab-pane fade" id="manageaccount" role="tabpanel" aria-labelledby="profile-tab">
				...
				<form action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="description" value="<?php if (isset($description)) {
																							echo $description;
			...
			<div class="tab-pane fade" id="accountsettings" role="tabpanel" aria-labelledby="accountsettings-tab">
				<form method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="text" id="mobile" pattern="[0-9]{10}" value="<?php if (isset($mb)) {
																						echo $mb;
																					} ?>" class="form-control" name="mob" required />
					</div>
					<div class="form-group">
						<label for="mobile">Phone</label>
						<input type="text" id="phone" pattern="[0-9]{10}" value="<?php if (isset($phn)) {
																						echo $phn;
																					} ?>" class="form-control" name="phn" required />
					</div>
					<div class="form-group">
