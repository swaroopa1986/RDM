...
{
	  if(mysqli_query($con,"update tblorder set pldstatus='$status' where pld_order_id='$order_id'"))
	  {
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;">Roopa Dental Material </span></a>
    <?php
	if(!empty($id))
	{
	?>
