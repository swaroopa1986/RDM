        ...
        <form action="" method="post">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" value="<?php if (isset($r_name)) {
                                                                        echo $r_name;
                                                                      } ?>" placeholder="Enter supplier Name" name="r_name" required />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="tel" class="form-control" pattern="[0-9]{10}" value="<?php if (isset($mob)) {
                                                                                echo $mob;
                                                                              } ?>" id="mob" placeholder="9123456578" name="mob" required />
          </div>
          <div class="form-group">
            <label for="phone">Phone:</label>
            <input type="tel" class="form-control" pattern="[0-9]{10}" id="phone" value="<?php if (isset($phone)) {
                                                                                            echo $phone;
                                                                                          } ?>" placeholder="01-12345678" name="phone" required>
          </div>
          <div class="form-group">
