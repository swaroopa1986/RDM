				...
				<table class="table">
					<tbody>
						...
						?>
								<tr>
									<td>
										<image src="../image/supplier/<?php echo $em . "/productimages/" . $res['pldimage']; ?>" height="80px" width="100px">
									</td>
				...
				<table class="table">
					...
					<tbody>
						...
						while ($roww = mysqli_fetch_array($quer_res)) {
							$pid = $roww['pld_product_id'];
							$qr = mysqli_query($con, "select * from tbproduct where product_id='$pid'");
