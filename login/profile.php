            ...
            <div class="tab-pane fade" id="manageaccount" role="tabpanel" aria-labelledby="manageaccount-tab">
			    <form method="post">
                    <div class="form-group">
                      ...
                      <input type="text" id="name" value="<?php if(isset($pld_name)){ echo $pld_name;}?>" class="form-control" name="name" required="required"/>
                    </div>
					
					<div class="form-group">
                      <label for="email">Email</label>
                      <input type="email" id="email" name="email" value="<?php if(isset($pld_email)){ echo $pld_email;}?>" class="form-control"  readonly/>
                    </div>
					<div class="form-group">
                      <label for="mobile">Mobile</label>
                      <input type="tel" id="mobile" class="form-control" name="mobile" pattern="[0-9]{10}" value="<?php if(isset($pld_mobile)){ echo $pld_mobile;}?>" required>
                    </div>
					
                   <div class="form-group">
                      <label for="pwd">Password:</label>
                     <input type="password" name="pswd" value="<?php if(isset($pld_password)) { echo $pld_password; }?>"class="form-control"  id="pwd" required/>
                   </div>
