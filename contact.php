...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
		...
		if (!empty($cust_id)) {
		?>
			<a href="login/profile.php" class="navbar-brand" style="color:black; text-decoration:none;"><i class="far fa-user"><?php if (isset($cust_id)) {
																																	echo $qqr['pld_name'];
																																} ?></i></a>
		<?php
		}
		...
		<div class="row">
			...
			<div class="col-sm-4" style="padding:30px;">
				<div class="form-group">
					...
					<i class="fa fa-home" aria-hidden="true"></i>&nbsp; 23-A ,North-East Campus,Dublin Road, Dublin EirCode-D01FG34<br>
				</div>
			</div>
		</div>
	</div>
